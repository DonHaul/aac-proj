...
-- UNCOMMENT THE LINES CORRESPONDING TO YOUR OPCODES
  ...
  --------------------------------------------------------------------------------------------------------------------------------
          ...
          1 =>  "00" &  x"0"   &  "0000" &  x"0"   &  "0000"   &  "001"  &  "00"  &  "11"  &  "00"  & "00"  &  '0' &  "00",  -- ADDI   R[DR],R[SA],SIMM18
          2 =>  "00" &  x"0"   &  x"0"   &  x"0"   &  "0011"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- SUB    R[DR],R[SA],R[SB]
          3 =>  "00" &  x"0"   &  "0000" &  x"0"   &  "0011"   &  "001"  &  "00"  &  "11"  &  "00"  & "00"  &  '0' &  "00",  -- SUBI   R[DR],R[SA],SIMM18
  --------------------------------------------------------------------------------------------------------------------------------
  -- OPCODE =>  PL  &  dAA   &   dBA    &  dDA    &   FS      &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
          4 =>  "00" &  x"0"  &   x"0"   &  x"0"   &  "0100"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- AND    R[DR],R[SA],R[SB]
          5 =>  "00" &  x"0"  &   "0000" &  x"0"   &  "0100"   &  "101"  &  "00"  &  "11"  &  "00"  & "00"  &  '0' &  "00",  -- ANDIL  R[DR],R[SA],IMM16
          6 =>  "00" &  x"0"  &   "0000" &  x"0"   &  "0100"   &  "111"  &  "00"  &  "11"  &  "00"  & "00"  &  '0' &  "00",  -- ANDIH  R[DR],R[SA],IMM16
          ...
          9 =>  "00" &  x"0"  &   "0000" &  x"0"   &  "0110"   &  "100"  &  "00"  &  "11"  &  "00"  & "00"  &  '0' &  "00",  -- ORIL   R[DR],R[SA],IMM16
         10 =>  "00" &  x"0"  &   "0000" &  x"0"   &  "0110"   &  "110"  &  "00"  &  "11"  &  "00"  & "00"  &  '0' &  "00",  -- ORIH   R[DR],R[SA],IMM16
  ...
  -- OPCODE =>  PL  &  dAA   & dBA      & dDA     &  FS       &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
         14 =>  "00" & "0000" &   x"0"   &  x"0"   &  "1010"   &  "000"  &  "10"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- LSL    R[DR],R[SB]
         15 =>  "00" & "0000" &   x"0"   &  x"0"   &  "1011"   &  "000"  &  "10"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- LSR    R[DR],R[SB]
         16 =>  "00" & "0000" &   x"0"   &  x"0"   &  "1110"   &  "000"  &  "10"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ROL    R[DR],R[SB]
         17 =>  "00" & "0000" &   x"0"   &  x"0"   &  "1111"   &  "000"  &  "10"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ROR    R[DR],R[SB]
         18 =>  "00" & "0000" &   x"0"   &  x"0"   &  "1100"   &  "000"  &  "10"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ASL    R[DR],R[SB]
         19 =>  "00" & "0000" &   x"0"   &  x"0"   &  "1101"   &  "000"  &  "10"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ASR    R[DR],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------
  -- OPCODE =>  PL  &  dAA   & dBA      & dDA      &   FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
         20 =>  "00" &  x"0"  &   x"0"   &  x"0"    &  "0000"  &  "000"  &  "00"  &  "00"  &  "11"  & "00"  &  '0' &  "01",  -- LD     R[DA],(R[AA]+R[BA])
         21 =>  "00" &  x"0"  &  "0000"  &  x"0"    &  "0000"  &  "001"  &  "00"  &  "11"  &  "11"  & "00"  &  '0' &  "01",  -- LDI    R[DA],(R[AA]+SIMM18)
  ...
  --------------------------------------------------------------------------------------------------------------------------------
         ...
         25 =>  "11" &  x"0"  &  "0000"  &  "0000"  &  "0011"  &  "100"  &  "00"  &  "10"  &  "00"  & "00"  &  '0' &  "10",  -- J.cond  (R[SA] cond R0),SIMM14
