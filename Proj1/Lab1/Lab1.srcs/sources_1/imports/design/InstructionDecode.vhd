...
-- UNCOMMENT THE LINES CORRESPONDING TO YOUR OPCODES
  ...
  --------------------------------------------------------------------------------------------------------------------------------
         ...
         22 =>  "00" &  x"0"  &   x"0"   &  "0000"  &  "0000"  &  "010"  &  "00"  &  "00"  &  "11"  & "10"  &  '1' &  "10",  -- ST     (R[AA]+SIMM18),R[SB]
  --------------------------------------------------------------------------------------------------------------------------------
  -- OPCODE =>  PL  &  dAA   &  dBA     &   dDA    &   FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
         ...
         25 =>  "10" &  x"0"  &  "0000"  &  "0000"  &  "0011"  &  "100"  &  "00"  &  "10"  &  "00"  & "00"  &  '0' &  "10",  -- J.cond  (R[SA] cond R[SB]),SIMM14
         26 =>  "10" &  x"0"  &  x"0"    &  "0000"  &  "0011"  &  "011"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "10",  -- JI.cond (R[SA] cond SIMM14),R[SB]
