...
-- UNCOMMENT THE LINES CORRESPONDING TO YOUR OPCODES
  ...
  --------------------------------------------------------------------------------------------------------------------------------
          ...
          1 =>  '0' &  x"0"   &  x"0"   &  x"0"   &  "0000"   &  "001"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "00",  -- ADDI   R[DR],R[SA],SIMM18
  ...
  -- OPCODE =>  PL  &  dAA   &   dBA    &  dDA    &   FS      &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
          4 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0100"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- AND    R[DR],R[SA],R[SB]
          5 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0100"   &  "101"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "00",  -- ANDIL  R[DR],R[SA],IMM16
          6 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0100"   &  "111"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "00",  -- ANDIH  R[DR],R[SA],IMM16
          7 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0101"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- NAND   R[DR],R[SA],R[SB]
          8 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0110"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- OR     R[DR],R[SA],R[BA]
          9 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0110"   &  "100"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "00",  -- ORIL   R[DR],R[SA],IMM16
         10 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0110"   &  "110"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "00",  -- ORIH   R[DR],R[SA],IMM16
         11 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "0111"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- NOR    R[DR],R[SA],R[SB]
         12 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1000"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- XOR    R[DR],R[SA],R[SB]
         13 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1001"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- XNOR   R[DR],R[SA],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------
  -- OPCODE =>  PL  &  dAA   & dBA      & dDA     &  FS       &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
         14 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1010"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- LSL    R[DR],R[SB]
         15 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1011"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- LSR    R[DR],R[SB]
         16 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1110"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ROL    R[DR],R[SB]
         17 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1111"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ROR    R[DR],R[SB]
         18 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1100"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ASL    R[DR],R[SB]
         19 =>  '0' &  x"0"  &   x"0"   &  x"0"   &  "1101"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ASR    R[DR],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------
  -- OPCODE =>  PL  &  dAA   & dBA      & dDA      &   FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
         20 =>  '0' &  x"0"  &   x"0"   &  x"0"    &  "0000"  &  "000"  &  "00"  &  "00"  &  "11"  & "00"  &  '0' &  "01",  -- LD     R[DA],(R[AA]+R[BA])
         21 =>  '0' &  x"0"  &   x"0"   &  x"0"    &  "0000"  &  "001"  &  "00"  &  "01"  &  "11"  & "00"  &  '0' &  "01",  -- LDI    R[DA],(R[AA]+SIMM18)
         22 =>  '0' &  x"0"  &   x"0"   &  "0000"  &  "0000"  &  "010"  &  "00"  &  "00"  &  "11"  & "10"  &  '1' &  "10",  -- ST     (R[AA]+SIMM18),R[SB]
  --------------------------------------------------------------------------------------------------------------------------------
  -- OPCODE =>  PL  &  dAA   &  dBA     &   dDA    &   FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------
         23 =>  '1' &  x"0"  &  x"0"    &  "0000"  &  "0011"  &  "011"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "10",  -- B.cond  (R[SA] cond R[SB]),SIMM14
         24 =>  '1' &  x"0"  &  x"0"    &  "0000"  &  "0011"  &  "011"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "10",  -- BI.cond (R[SA] cond SIMM14),R[SB]
         25 =>  '1' &  x"0"  &  "0000"  &  "0000"  &  "0011"  &  "100"  &  "00"  &  "10"  &  "00"  & "00"  &  '0' &  "10",  -- J.cond  (R[SA] cond R[SB]),SIMM14
         26 =>  '1' &  x"0"  &  x"0"    &  "0000"  &  "0011"  &  "011"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "10",  -- JI.cond (R[SA] cond SIMM14),R[SB]
