...
-- UNCOMMENT THE LINES CORRESPONDING TO YOUR OPCODES
  ...
  --------------------------------------------------------------------------------------------------------------------------------  
          ...
          1 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  "0000"   &  "001"  &  "00"  &  "-1"  &  "00"  & "00"  &  '0' &  "00",  -- ADDI   R[DR],R[SA],SIMM18
          2 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  "0011"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- SUB    R[DR],R[SA],R[SB]
          3 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  "0011"   &  "001"  &  "00"  &  "-1"  &  "00"  & "00"  &  '0' &  "00",  -- SUBI   R[DR],R[SA],SIMM18
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL      &  dAA     & dBA        & dDA        &  FS        &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0100"   &  "---"  &  "00"  &  "00"  &  "--"  & "--"  &  '0' &  "00",  -- AND    R[DR],R[SA],R[SB]
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0100"   &  "101"  &  "00"  &  "-1"  &  "--"  & "--"  &  '0' &  "00",  -- ANDIL  R[DR],R[SA],IMM16
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0100"   &  "111"  &  "00"  &  "-1"  &  "--"  & "--"  &  '0' &  "00",  -- ANDIH  R[DR],R[SA],IMM16
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0101"   &  "---"  &  "00"  &  "00"  &  "--"  & "--"  &  '0' &  "00",  -- NAND   R[DR],R[SA],R[SB]
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0110"   &  "---"  &  "00"  &  "00"  &  "--"  & "--"  &  '0' &  "00",  -- OR     R[DR],R[SA],R[BA]
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0110"   &  "100"  &  "00"  &  "-1"  &  "--"  & "--"  &  '0' &  "00",  -- ORIL   R[DR],R[SA],IMM16
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0110"   &  "110"  &  "00"  &  "-1"  &  "--"  & "--"  &  '0' &  "00",  -- ORIH   R[DR],R[SA],IMM16
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "0111"   &  "---"  &  "00"  &  "00"  &  "--"  & "--"  &  '0' &  "00",  -- NOR    R[DR],R[SA],R[SB]
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "1000"   &  "---"  &  "00"  &  "00"  &  "--"  & "--"  &  '0' &  "00",  -- XOR    R[DR],R[SA],R[SB]
--          0 =>  '0' &   x"----"  &  x"----"   &  x"----"   &  "1001"   &  "---"  &  "00"  &  "00"  &  "--"  & "--"  &  '0' &  "00",  -- XNOR   R[DR],R[SA],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA       & dBA     & dDA       &  FS        &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
--          0 =>  '0' &   x"-"  &  x"-"   &  x"----"   &  "1010"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- LSL    R[DR],R[SB]
--          0 =>  '0' &   x"-"  &  x"-"   &  x"----"   &  "1011"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- LSR    R[DR],R[SB]
--          0 =>  '0' &   x"-"  &  x"-"   &  x"----"   &  "1110"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ROL    R[DR],R[SB]
--          0 =>  '0' &   x"-"  &  x"-"   &  x"----"   &  "1111"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ROR    R[DR],R[SB]
--          0 =>  '0' &   x"-"  &  x"-"   &  x"----"   &  "1100"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ASL    R[DR],R[SB]
--          0 =>  '0' &   x"-"  &  x"-"   &  x"----"   &  "1101"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ASR    R[DR],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL    &  dAA    & dBA       & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
--          0 =>  '0' &   x"0"  &  x"0"   &  x"0"     &  x"0"   &  "000"  &  "00"  &  "00"  &  "11"  & "00"  &  '0' &  "01",  -- LD     R[DA],(R[AA]+R[BA])
--          0 =>  '0' &   x"0"  &  x"0"   &  x"0"     &  x"0"   &  "001"  &  "00"  &  "01"  &  "11"  & "00"  &  '0' &  "01",  -- LDI    R[DA],(R[AA]+SIMM18)
--          0 =>  '0' &   x"0"  &  x"0"   &  "0000"   &  x"0"   &  "010"  &  "00"  &  "00"  &  "11"  & "10"  &  '1' &  "10",  -- ST     (R[AA]+SIMM18),R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>     PL  &  dAA    & dBA       & dDA     &  FS     &  KNSSel   &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
 --          0 =>  '1' &   x"0"  &  x"0"   &  "0000"   &  "0011"   &  "011"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "10",  -- B.cond  (R[SA] cond R[SB]),SIMM14
 --          0 =>  '1' &   x"0"  &  x"0"   &  "0000"   &  "0011"   &  "011"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "10",  -- BI.cond (R[SA] cond SIMM14),R[SB]
 --          0 =>  '1' &   x"0"  &  "0000"  &  "0000"  &  "0011"   &  "100"  &  "00"  &  "10"  &  "00"  & "00"  &  '0' &  "10",  -- J.cond  (R[SA] cond R[SB]),SIMM14
 --          0 =>  '1' &   x"0"  &  x"0"   &  "0000"   &  "0011"   &  "011"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "10",  -- JI.cond (R[SA] cond SIMM14),R[SB]
